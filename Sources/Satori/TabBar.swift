...
struct TabBar: View {
    ...
    var body: some View {
        ...
        // Worn in the page's own colour: fully solid while the page is at its
        // top, a little see-through once it has scrolled.
        .background((browser.themeColor ?? Palette.ground).opacity(browser.scrolledUnder ? 0.7 : 1))
